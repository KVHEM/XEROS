...
Creates metadata file for all station called pages2k_meta and metadata file called pages2k_meta_id that is only for stations in europe that are conected to grid cell by id.
...
import_ghcn_p.R : It downloads daily and monthly precipitation data from europian stations. 
...
Stations from europe were picked from metadata, conected to grid cell ids and saved separetly into eu metadata.
